...
public class AnalogComplicationWatchFaceService extends CanvasWatchFaceService {
    ...
    private class Engine extends CanvasWatchFaceService.Engine {
        ...
        private void loadSavedPreferences() {
            ...
            mBackgroundColor = mSharedPref.getInt(backgroundColorResourceName, Color.WHITE);
        ...
        private void initializeWatchFace() {
            ...
            mHourPaint.setColor(Color.parseColor("#b3b3b3"));
            mHourPaint.setStrokeWidth(HOUR_STROKE_WIDTH);
            mHourPaint.setAntiAlias(true);
            mHourPaint.setStrokeCap(Paint.Cap.ROUND);
            mHourPaint.setStyle(Paint.Style.FILL_AND_STROKE);
            mHourPaint.setShadowLayer(SHADOW_RADIUS, 0, 0, Color.parseColor("#b3b3b3"));

            mMinutePaint = new Paint();
            mMinutePaint.setColor(Color.parseColor("#b3b3b3"));
            mMinutePaint.setStrokeWidth(MINUTE_STROKE_WIDTH);
            mMinutePaint.setAntiAlias(true);
            mMinutePaint.setStrokeCap(Paint.Cap.ROUND);
            mMinutePaint.setStyle(Paint.Style.FILL_AND_STROKE);
            mMinutePaint.setShadowLayer(SHADOW_RADIUS, 0, 0, Color.parseColor("#b3b3b3"));
            ...
            c = new Paint();
            c.setColor(Color.parseColor("#b3b3b3"));
            c.setStrokeWidth(5f);
            c.setAntiAlias(true);
        ...
        private void updateWatchPaintStyles() {
            if (mAmbient) {
                ...
                mSecondAndHighlightPaint.setColor(Color.parseColor("#b3b3b3"));
                mTickAndCirclePaint.setColor(Color.RED);
        ...
        public void onSurfaceChanged(SurfaceHolder holder, int format, int width, int height) {
            ...
            mMinuteHandLength = (float) (mCenterX * 0.85);
        ...
        private void drawUnreadNotificationIcon(Canvas canvas) {
            ...
            if (mUnreadNotificationsPreference && (mNumberOfUnreadNotifications > 0)) {
                ...
                mSecondAndHighlightPaint.setColor(Color.RED);
                canvas.drawCircle(width / 2, height - 40, 10, mSecondAndHighlightPaint);
...
//                        mTickAndCirclePaint);
                            ...
                            canvas.drawCircle(
                    mCenterX + innerX*0.9f,
                    mCenterY + innerY*0.9f,
                    CENTER_GAP_AND_CIRCLE_RADIUS-3f,
                    c);
            }
             ...
             */
            Paint p = new Paint();
            RectF rectF = new RectF(mCenterX-innerTickRadius, mCenterY-innerTickRadius, mCenterX+innerTickRadius, mCenterY+innerTickRadius);

            p.setStrokeWidth(5f);
            p.setAntiAlias(true);
            p.setStyle(Paint.Style.STROKE);
//            p.setStrokeWidth(mCenterX * 2);
            ...
            if (sweepAngle < 2) {
                startAngle -= 0.5f * 2;
                sweepAngle += 0.5f * 2;
            } else if (sweepAngle > 360f - 2) {
                startAngle += 0.5f * 2;
                sweepAngle -= 0.5f * 2;
            }
            p.setColor(Color.parseColor("#f2f2f2"));
                        canvas.drawCircle(
                    mCenterX, mCenterY, innerTickRadius, p);
            p.setColor(Color.parseColor("#0066ff"));
            canvas.drawArc (rectF, startAngle, sweepAngle, false, p);
            canvas.save();

            canvas.rotate(hoursRotation, mCenterX, mCenterY);
            Paint v = new Paint();
            v.setColor(Color.parseColor("#b3b3b3"));
            v.setStrokeWidth(3f);
            v.setAntiAlias(true);
            ...
            if (!mAmbient) {
                ...
                canvas.drawLine(
                        mCenterX,
                        mCenterY - CENTER_GAP_AND_CIRCLE_RADIUS+20f,
                        mCenterX,
...
//            canvas.drawCircle(
//                    mCenterX, mCenterY, CENTER_GAP_AND_CIRCLE_RADIUS+2f, mSecondAndHighlightPaint);
